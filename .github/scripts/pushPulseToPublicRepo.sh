...
sed -i 's/\(.*version:.*\)/version: '"$HELM_PULSE_VERSION"'/g' Charts/qtest-chart/Chart.yaml
sed -i 's/\(.*appVersion:.*\)/appVersion: '"$PULSE_APP_VERSION"'/g' Charts/qtest-chart/Chart.yaml
